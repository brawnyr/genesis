...
struct Metronome {
    ...
    private static let attackDuration: Double = 0.0005  // 0.5ms fade-in

    // Four distinct beats — warm, analog-style
    private static let beatParams: [(freq: Double, amp: Float)] = [
        (880.0, 0.70),   // beat 1 — warm downbeat, the ONE
        (660.0, 0.35),   // beat 2 — soft
        (720.0, 0.42),   // beat 3 — medium
        (620.0, 0.30),   // beat 4 — softest
    ]
